 ...
 * http
 */
$cfg['blowfish_secret'] = '2225213043116317746'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
/**
...
$cfg['Servers'][$i]['controlpass']   = '';          // access to the "mysql/user"
                                                    ...
                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     = 'http';    // Authentication method (config, http or http based)?
